...
#ifndef MXGAME_OGRE_CORE_SETUP_RESOURCES_EXCEPTION_HPP_
#define MXGAME_OGRE_CORE_SETUP_RESOURCES_EXCEPTION_HPP_
...
#endif /* MXGAME_OGRE_CORE_SETUP_RESOURCES_EXCEPTION_HPP_ */
