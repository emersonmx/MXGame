...
#ifndef MXGAME_GRAPHIC_OGRE_DEFAULT_SCENE_NODE_BUILDER_HPP_
#define MXGAME_GRAPHIC_OGRE_DEFAULT_SCENE_NODE_BUILDER_HPP_

#include <OgreSceneManager.h>

#include <mxgame/graphic/ogre_scene_node_builder.hpp>

namespace mxgame {

class OgreDefaultSceneNodeBuilder : public OgreSceneNodeBuilder {
    public:
        OgreDefaultSceneNodeBuilder(Ogre::SceneManager* scene_manager=NULL,
...
#endif /* MXGAME_GRAPHIC_OGRE_DEFAULT_SCENE_NODE_BUILDER_HPP_ */
