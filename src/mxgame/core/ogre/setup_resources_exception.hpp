...
#ifndef MXGAME_CORE_OGRE_SETUP_RESOURCES_EXCEPTION_HPP_
#define MXGAME_CORE_OGRE_SETUP_RESOURCES_EXCEPTION_HPP_
...
#endif /* MXGAME_CORE_OGRE_SETUP_RESOURCES_EXCEPTION_HPP_ */
